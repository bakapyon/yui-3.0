### Proyecto Yui
Yui es un bot en inglés, español y portugués creado y actualizado por Lucas R. - KillovSky para el grupo "Horizon", tiene más de 200 comandos y actualizaciones frecuentes con correcciones y novedades.

### Otros idiomas
If want a english tutorial, open this [English Tutorial](https://github.com/KillovSky/yui/blob/main/.readme/en/README.md), para um português use o [Tutorial PT-BR](https://github.com/KillovSky/yui/blob/main/README.md).
Para dejar su bot completamente en otro idioma, abra la configuración de [Idioma aquí](https://github.com/KillovSky/yui/blob/main/lib/config/config.json#2) y cambie el "pt" por "en" que es inglés o "es" para español, no hay otros idiomas que estos.
...
### Errores
Si observa errores, lea el [Discussions](https://github.com/KillovSky/yui/discussions), si no resuelve, háblame por los medios que se encuentran en la parte inferior de la página o infórmalo en [Issues](https://github.com/KillovSky/yui/issues), y por supuesto, asegúrese de haber instalado Chrome y leer TODO lo escrito abajo.
...
- [Lenguaje](https://github.com/KillovSky/yui/blob/main/lib/config/Bot/config.json#2)
...
- [Requisito de miembros](https://github.com/KillovSky/yui/blob/main/lib/config/Bot/config.json#11)
...
### Crea tus comandos
Hay una base simple para sus creaciones por [aqui](https://github.com/KillovSky/yui/blob/main/config.js#L3554), solo tienes que quitar el "/\*" e la "\*/" para usarlo, si necesita otros tipos, puede ver sobre ellos para [aqui](https://docs.openwa.dev/classes/api_client.client.html), si tienes dificultades llámame por [aqui](https://chat.whatsapp.com/H53MdwhtnRf7TGX1VJ2Jje) o [aqui](https://wa.me/+5511981736389).

### Computer-Freaker/Axios
Para solucionar el funcionamiento de la API Computer-Freaker (Baguette, Yuri, Hug ...) y algunos problemas en el módulo Axios, siga los pasos en este [Mini-Tutorial](https://github.com/KillovSky/yui/discussions/10).

### Alertas en WhatsApp
Para recibir también mensajes de error de yui a través de WhatsApp, elimine el "//" de la línea [Catch](https://github.com/KillovSky/yui/blob/main/config.js#L3566).
...
- [Dono] - Si necesitas hablar conmigo (siempre respondo lo más rápido posible) - [Falar](https://wa.me/+5511981736389)